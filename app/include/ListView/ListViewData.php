...
// ranjeev - exclamation sign for small into for the module.
// created a file known as verify.php in the root directory and linked it with the below function. The popup url containing a variable of $id
// which is helping to get the details of user. This variable $id is keeping the contacts_id or account_id or similar data based on the use of modules.
        $extra = "<a href='http://localhost/verify.php?profileid=$id' 
        target='popup' 
        onclick='window.open('http://localhost/verify.php?profileid=$id','popup','width=600,height=600'); return false;'>
          Verification
      </a>";
